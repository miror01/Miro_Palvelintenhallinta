...
b. SSH-kirjautuminen automatisoitu. Komennolla **ssh-keygen -t ed25519 -C miron_avain** loin oman avaimeni ja lisäsin sen omalle palvelimelleni komennolla **ssh-copy-id localhost**. Nyt SSH-kirjautuminen on automatisoitu.
