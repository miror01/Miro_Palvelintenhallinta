...
Apache2-palvelin käyttää jo samaa porttia, 80, ja poistin Apache2:n tilapäisesti käytöstä, **sudo systemctl stop apache2**, ja käynnistin Caddyn komennolla **sudo systemctl start caddy**, ja tarkistin statuksen aiemmalla komennolla
